  ...
  <div class="device-intro">
    ...
    <div id="glance_grid">
      <div class="glance-item">
        <i class="fas fa-rocket-launch"></i> Android 9.0
      </div>
      <div class="glance-item">
        <i class="fas fa-arrow-alt-up"></i> <a href="/security/releases/t8/t8-001_20210605">Android 10</a>
      </div>
      <div class="glance-item">
        <i class="fas fa-memory"></i> 2GB/3GB RAM
      </div>
      <div class="glance-item">
        <i class="fas fa-hdd"></i> 32GB Storage
      </div>
      <div class="glance-item">
        <i class="fas fa-signal"></i> Global LTE
      </div>
      <div class="glance-item">
        <i class="fas fa-badge-check"></i> EMM validated
      </div>
      </div>
      <div class="glance-item">
      <span class="material-icons">nfc</span> With/without NFC
      </div>
    </div>
  </div>
</div>
