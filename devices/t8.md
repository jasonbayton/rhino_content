...
| <i class="fab fa-android"></i> [Upgrade to Android 10](/security/releases/t8/t8-001_20210605)  | <i class="fas fa-signal"></i> Global LTE | <span class="fa-stack fa-2x"> <i class="far fa-certificate fa-stack-2x"></i>  <i class="fab fa-abdroid fa-stack-1x fa-inverse"></i></span> EMM validated |
</div>
