...
|||||
|-|-|-|-|
| Launched:  <i class="fab fa-android"></i> Android 9.0 | Available:  <i class="fab fa-android"></i> Android 10 | Memory:  <i class="fas fa-memory"></i> 2GB/3GB | Storage:  <i class="fas fa-hdd"></i> 32GB |
</div>
